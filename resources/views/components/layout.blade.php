      ...
      <footer class="footer">
        <div class=" container-fluid ">
          ...
          <nav>
            ...
            <ul>
              <li>
                <a href=" link sa financia report or chuchunes">
                  Financial Reports
                </a>
              </li>
              <li>
                <a href="link sa about us page">
                  About Us
                </a>
              </li>
              <li>
                <a href="link sa contact us ">
                  Contact us
                </a>
              </li>
          ...
          <div class="copyright" id="copyright">
            ...
            </script>, Designed by <a href="linkkkk sa fotter about us " target="_blank">Richard pogi</a>. and friends<a href="Digdi undecided pa" target="_blank">Financial Tracker team nwhashhasd</a>.
          </div>
        </div>
      </footer>
    </div>
